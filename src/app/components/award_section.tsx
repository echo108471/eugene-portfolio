...
const AwardCard: React.FC<AwardCardProps> = ({ name, organization }) => {
  return (
    <div className="block bg-white rounded-lg shadow-md p-6 border border-gray-200 hover:bg-gray-100 dark:bg-innerbox-dark dark:border-accent-dark dark:hover:bg-accent-dark">
